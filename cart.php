...
<section class="shopping-cart">
        ...
        if (mysqli_num_rows($select_cart) > 0) {
            while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                ...
                <div class="box">
                    ...
                    <div class="price">₱<?php echo number_format($fetch_cart['Price']); ?></div>
                    ...
                    <div class="sub-total"> sub-total : <span>₱<?php echo number_format($sub_total = ($fetch_cart['Price'] * $fetch_cart['Quantity'])); ?></span> </div>
                </div>
                <?php
    ...
    <div class="cart-total">
        ...
        <a href="checkout.php" class="btn  <?php echo number_format($grand_total > 1) ? '' : 'disabled' ?>">proceed to checkout</a>
    </div>
